...
i2c_status_t
tda4_recv(void *hdl, void *buf, unsigned len, unsigned stop)
{
    tda4_dev_t  *dev = hdl;
    ...
    if (tda4_wait_bus_not_busy(dev, stop) == -1) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/i2c/tda4/recv.c $ $Rev: 961968 $")
#endif
