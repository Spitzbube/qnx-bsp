 ...
 *
 * @file       sdmmc/aarch64/am65x.le/sim_bs.h
 * @addtogroup sdmmc_bs
 * @{
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/devb/sdmmc/aarch64/am65x.le/sim_bs.h $ $Rev: 878382 $")
#endif
