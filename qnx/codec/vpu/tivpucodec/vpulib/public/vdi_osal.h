...
#define LOG_TAG "VPUAPI"
  ...
  #define codec_slogtrace(...)            slogf(_SLOG_SETCODE(_SLOGC_PRIVATE_START, 99), _SLOG_DEBUG2, "Entering "__VA_ARGS__)
  #define codec_slogdbg(...)              slogf(_SLOG_SETCODE(_SLOGC_PRIVATE_START, 99), _SLOG_DEBUG1, __VA_ARGS__)
#else
  #define codec_slogtrace(...)
  #define codec_slogdbg(...)
#endif
#define codec_sloginfo(...)             slogf(_SLOG_SETCODE(_SLOGC_PRIVATE_START, 99), _SLOG_INFO, __VA_ARGS__)
#define codec_slogerr(...)              slogf(_SLOG_SETCODE(_SLOGC_PRIVATE_START, 99), _SLOG_ERROR, __VA_ARGS__)
#define codec_slogwarn(...)             slogf(_SLOG_SETCODE(_SLOGC_PRIVATE_START, 99), _SLOG_WARNING, __VA_ARGS__)
