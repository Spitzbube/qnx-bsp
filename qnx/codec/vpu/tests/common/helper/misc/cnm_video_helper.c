        ...
        if (interLeave == TRUE) {
            if (cnt == 2 && ((YUV_y%2)==0)) {
                ...
                case FORMAT_422_P10_32BIT_MSB:
                    ...
                    vdi_write_memory(coreIdx, nextWriteAddrCb + stride * mem_y/cnt, (Uint8 *)(srcCb+ YUV_y/cnt * (picWidth*2)), picWidth, endian);
                    break;
                default:
                    vdi_write_memory(coreIdx, nextWriteAddrCb, (Uint8 *)(srcCb+ YUV_y/cnt * picWidth), picWidth, endian);
                    break;
    ...
    )
{
    ...
    offsetX   = (enableCrop == TRUE ? cropRect.left * 2: 0);
    ...
    case FORMAT_422_P10_32BIT_MSB:
        ...
        break;
#ifdef SUPPORT_COLOR_SPACE_CONVERSION_YUV2RGB
    case FORMAT_RGB:
    case FORMAT_RGB_P10_32BIT:
        dstWidth = width * 4;
        dstChromaWidth = 0;
        dstChromaHeight = 0;
        copyLumaOnly = TRUE;
