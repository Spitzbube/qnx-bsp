...
typedef struct YuvFeederImpl {
    ...
    BOOL      (*Feed)(struct YuvFeederImpl* impl, Int32   coreIdx, FrameBuffer *fb, size_t picWidth, size_t picHeight, Uint32 srcFbIndex, ENC_subFrameSyncCfg* subFrameSyncConfig, void* arg);
...
typedef struct TestDecConfig_struct {
    ...
    int                 cbcrInterleave;             //!<< 0: None, 1: Interleaved
    int                 nv21;                       //!<< 0: NV12, 1: NV21,
                                                    //!<< This variable is valid when cbcrInterleave is set to 1
