...
#if defined TEST_ENCODER
#include "component_list_encoder.h"
#elif defined TEST_DECODER
#include "component_list_decoder.h"
#elif defined TEST_ENCODER_DECODER
#include "component_list_all.h"
#endif
