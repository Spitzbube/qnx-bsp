...
main(int argc, char **argv, char **envv)
{
    ...
    add_typed_string(_CS_MACHINE, "AM335X BeagleBone");
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/ti-am335x/beaglebone/main.c $ $Rev: 784133 $")
#endif
